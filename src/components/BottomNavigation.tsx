      ...
      <div className="relative w-full" style={{ aspectRatio: "414/84" }}>
        ...
        >
          ...
          <path
            ...
            fill={isDark ? (path === "/" ? "white" : "#B6B6B6") : (path === "/" ? "black" : "#B6B6B6")}
          />
          {/* Report 아이콘 */}
          <path
            ...
            fill={isDark ? ((path === "/routine" || path === "/contents") ? "white" : "#B6B6B6") : ((path === "/routine" || path === "/contents") ? "black" : "#B6B6B6")}
          />
          ...
          <path
            ...
            fill={isDark ? (path === "/analysis" ? "white" : "#B6B6B6") : (path === "/analysis" ? "black" : "#B6B6B6")}
          />
          {/* 캘린더 아이콘 복원 */}
          <path
            fillRule="evenodd"
            ...
            fill={isDark ? (path === "/calendar" ? "white" : "#B6B6B6") : (path === "/calendar" ? "black" : "#B6B6B6")}
          />
        </svg>
        {/* 클릭 영역 */}
