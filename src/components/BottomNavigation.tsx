      ...
      <Link to="/report">
        <div className="flex flex-col items-center">
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            color={path === "/report" ? "#ffffff" : "#9C9C9C"}
          >
            <path
              d="M10 9H6"
              stroke={path === "/report" ? "#ffffff" : "#9C9C9C"}
              strokeWidth="1.5"
              strokeLinecap="round"
        ...
        <div className="flex flex-col items-center">
          ...
          >
            <path
              ...
              stroke={path === "/analysis" ? "#ffffff" : "#9C9C9C"}
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
          ...
          <span
            className={`text-xs ${path === "/analysis" ? "text-white font-medium" : "text-[#9C9C9C] font-normal"}`}
          >
            Analysis
          </span>
        </div>
      ...
      <Link to="/Action">
        <div className="flex flex-col items-center">
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            color={path === "/action" ? "#ffffff" : "#9C9C9C"}
          >
            <path
              ...
              stroke={path === "/action" ? "#ffffff" : "#9C9C9C"}
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            ></path>
