      ...
      <div className="flex justify-around items-center py-3 divide-x-2 divide-gray-200">
        ...
        <div className="flex items-start gap-2 px-6">
          <img
            ...
            style={{
              filter:
                "invert(73%) sepia(89%) saturate(4477%) hue-rotate(204deg) brightness(93%) contrast(91%)",
            }}
          />
          <div>
        ...
        <div className="flex items-start gap-2 px-6">
          <img
            ...
            style={{
              filter:
                "invert(64%) sepia(4%) saturate(5367%) hue-rotate(309deg) brightness(92%) contrast(104%)",
            }}
          />
          <div>
        ...
        <div className="flex items-start gap-2 px-6">
          <img
            ...
            style={{
              filter:
                " invert(32%) sepia(11%) saturate(2571%) hue-rotate(205deg) brightness(95%) contrast(83%)",
            }}
          />
          <div>
