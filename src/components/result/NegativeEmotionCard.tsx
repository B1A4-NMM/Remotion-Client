...
interface NegativeEmotionCardProps {
  emotionType: "stress" | "anxiety" | "depression" | "sadness" | "anger";
}
...
const NegativeEmotionCard: React.FC<NegativeEmotionCardProps> = ({ emotionType }) => {
  ...
  return (
    <div className="bg-[#ffffff] dark:bg-[#4A3551] p-1 mt-4 rounded-lg mb-4 text-black dark:text-white shadow-md border border-gray-200 dark:border-gray-600">
