...
> = {
  호랑이: {
    harmony: "팬더",
    description_h:
      "안정되고 따뜻한 팬더는 호랑이의 과열된 에너지를 부드럽게 감싸주며 균형을 맞춰 줍니다.",
    disHarmony: "코브라",
    description_d: "호랑이의 직진성과 코브라의 회피적이고 시기심 많은 성향은 자주 충돌합니다.",
  },
  새: {
    harmony: "나무늘보",
    description_h: "나무늘보의 느긋한 안정감은 족제비의 불안을 부드럽게 감싸줍니다.",
    disHarmony: "독수리",
    description_d: "독수리는 경쟁과 독립을 중시해, 감정적 지지가 필요한 족제비를 외롭게 만듭니다.",
  },
  강아지: {
    harmony: "고양이",
  ...
  나무늘보: {
    harmony: "새",
    description_h: "족제비의 감정 기복을 느긋한 속도로 따뜻하게 받아줍니다.",
    disHarmony: "독수리",
  ...
  고래: {
    ...
    disHarmony: "새",
    description_d: "고래는 변화를 싫어하고, 족제비는 감정의 요동을 멈추기 어려워 충돌합니다.",
  },
  거북이: {
    harmony: "나무늘보",
