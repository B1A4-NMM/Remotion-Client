...
const Positive=()=>{
    ...
    const emotions: MentalType[] = ["활력", "유대", "안정"];
        ...
        <div className="mb-10">
            ...
            <div className="pl-3 pr-3">
                <div className="bg-white rounded-3xl shadow-xl mb-4">
                    <div className="text-xl font-bold p-3"> 일자별 긍정적 감정 수치</div>
                    {isLoading ? (
                        <LoadingAnimation />
                    ) : (
                    <MentalChart
                ...
                <div className="bg-white rounded-3xl shadow-xl mb-4">
                    <div className="text-xl font-bold pt-5 pl-5 pb-2"> 긍정적 감정별 활동 TOP 10</div>
                        <ActivitySection type="긍정" data={allActivityData} />
                    <div className="text-xl font-bold pt-5 pl-5 mt-10"> 긍정적 감정에 가장 큰 영향을 준 사람 TOP 3</div>
                        <PeopleSection type="긍정" data={allPeopleData} />
                </div>
            </div>
        </div>
    )
